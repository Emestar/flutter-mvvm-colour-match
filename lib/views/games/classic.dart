...
import 'package:color_match/viewmodels/classic_game_viewmodel.dart';
...
class GameModeClassic extends StatefulWidget {
  const GameModeClassic({super.key});

  @override
  State<GameModeClassic> createState() => _GameModeClassicState();
}

class _GameModeClassicState extends State<GameModeClassic> {
  bool _dialogShown = false;

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => ClassicGameViewModel(),
      child: Consumer<ClassicGameViewModel>(
  ...
  void _showGameOverDialog(
      BuildContext context, ClassicGameViewModel viewModel, int score) {
    showDialog(
      context: context,
